...

<ROUTINE ORPHAN-MERGE ("AUX" (CNT -1) VERB BEG END
...
<ROUTINE CLAUSE-COPY (SRC DEST
		      "AUX" (IBEG <>) IEND OCL BEG END BB EE OBEG CNT)
...
<ROUTINE GENERIC-STAIRS (X)	;"in KITCHEN"
...
<ROUTINE GENERIC-LENS (X)
 <COND (<REMOTE-VERB?>
	,LENS)
       (<NOT <FSET? ,LENS-2 ,SEENBIT>>
	,LENS-1)>>

<ROUTINE GENERIC-RECORDER (X)
 <COND (<NOT <FSET? ,JACK-TAPE ,SEENBIT>>
	,RECORDER)>>

<ROUTINE GENERIC-BOX (X)
...
<ROUTINE GENERIC-WELL (X)
 <COND (<NOT <EQUAL? ,HERE ,BASEMENT>>
	,WELL)>>

<ROUTINE GENERIC-SKELETON (X)
 <COND (<FSET? ,SKELETON ,SEENBIT>
	,SKELETON)>>

<ROUTINE GENERIC-ROOM (X) ,GLOBAL-HERE>

<ROUTINE GENERIC-EYE (X)
 <COND (<EQUAL? ,W?EYE ,P-NAM ,P-XNAM>
	,GLASS-EYE)>>

<ROUTINE GENERIC-BELL (X)
 <COND (<REMOTE-VERB?> ,BELL)>>

<ROUTINE GENERIC-WINE (X)
